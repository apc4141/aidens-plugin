...
public class GiveMechanicalBootsCommand implements CommandExecutor {

    private Main plugin;

    public GiveMechanicalBootsCommand(Main plugin)
    {
        this.plugin = plugin;
    }
    ...
    {
        //Create item
        ItemStack itemStack = CustomMetaManager.createMechanicalBoots();
