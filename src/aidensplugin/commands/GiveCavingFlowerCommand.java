...
public class GiveCavingFlowerCommand implements CommandExecutor {

    private Main plugin;

    public GiveCavingFlowerCommand(Main plugin)
    {
        this.plugin = plugin;
    }
    ...
    {
        //Create item
        ItemStack itemStack = CustomMetaManager.createEscapeFlower();
