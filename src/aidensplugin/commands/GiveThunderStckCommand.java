...
public class GiveThunderStckCommand implements CommandExecutor {

    private Main plugin;

    public GiveThunderStckCommand(Main plugin)
    {
        this.plugin = plugin;
    }
    ...
    {
        //Create item
        ItemStack itemStack = CustomMetaManager.createThunderStick();
