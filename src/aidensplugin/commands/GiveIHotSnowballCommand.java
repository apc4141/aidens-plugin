...
public class GiveIHotSnowballCommand implements CommandExecutor {

    private Main plugin;

    public GiveIHotSnowballCommand(Main plugin)
    {
        this.plugin = plugin;
    }
    ...
    {
        //Create item
        ItemStack itemStack = CustomMetaManager.createInfiniteHotSnowball();
